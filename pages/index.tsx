  ...
  return (
    <BaseLayout isHomePage>
      <Head>
        ...
        <meta
          content={
            "Vivek Mittal is a Software Engineer-1 currently working at Shaadi.com with more than 2.5 years of experience in building scalable and reliable frontend web applications."
          }
          name="description"
        />
